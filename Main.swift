...
print("Balloon \(firstBalloon.getBalloonID()) is at (\(firstBalloon.getXPosition()), " +
      "\(firstBalloon.getYPosition())) and is \(firstBalloon.getBalloonColor())")

print("Balloon \(secondBalloon.getBalloonID()) is at (\(secondBalloon.getXPosition()), " +
      "\(secondBalloon.getYPosition())) and is \(secondBalloon.getBalloonColor())")
...
print("Balloon \(firstBalloon.getBalloonID()) is now at (\(firstBalloon.getXPosition()), " +
      "\(firstBalloon.getYPosition())) and is \(firstBalloon.getBalloonColor())")

print("Balloon \(secondBalloon.getBalloonID()) is now at (\(secondBalloon.getXPosition()), " +
      "\(secondBalloon.getYPosition())) and is \(secondBalloon.getBalloonColor())")
